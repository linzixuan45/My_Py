...
for i in range(10):
    ...
    heards = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36 SLBrowser/7.0.0.12151 SLBChan/11'}
    ...
    with open('rank','wb') as f:
        for title, rank in zip(titles, ranks):
            f.write(f'{title},{rank}+\n')
    # 随机休眠1-5秒，避免爬取页面过于频繁
